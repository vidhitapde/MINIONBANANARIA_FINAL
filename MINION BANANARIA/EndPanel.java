...
public class EndPanel extends JLayeredPane implements ActionListener
{
    ...
    JLabel winScreen; //displays scene for player when loses
    JLabel loseScreen; // displays win scene for player when wins
    /**
    ...
    // instantiates instance variables 
    {
        ...
        loseScreen = new JLabel(); 
        ImageIcon closedIMG  = new ImageIcon(getClass().getResource("assets/Bakery Closed.jpg"));
        loseScreen.setIcon(closedIMG); 
        loseScreen.setBounds(0,0,1000,750); 
    }
