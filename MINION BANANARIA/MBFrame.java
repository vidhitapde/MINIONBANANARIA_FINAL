...
public class MBFrame extends JFrame
{
    ...
    AudioInputStream audioStream; //responsible for the music in the game
    Clip clip; // is the clip of music that is used throughout the game
    /**
    ...
    // also gets the music playing in the game 
    ...
    public void stopMusic(){
        clip.stop(); // stops the clip of music 
    }
