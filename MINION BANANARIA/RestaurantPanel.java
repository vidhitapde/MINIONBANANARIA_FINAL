...
public class RestaurantPanel extends JLayeredPane implements ActionListener
{
    ...
    ArrayList<ImageIcon> minionimgs; // responsible for holding the different images for the different minions
    ...
    //Initializes instance variables
    {
        ...
        minionimgs = new ArrayList<ImageIcon>();
        minionimgs.add(new ImageIcon(getClass().getResource("assets/Kid Minion.png")));
        minionimgs.add(new ImageIcon(getClass().getResource("assets/Bob Minion.png")));
    ...
    //Checks if orders have been completed and updates screen accordingly and adds the new minion images
    {
        if(myRestaurant.getOrderNum() == myRestaurant.getOrderLength()){
            ...
            if ((myRestaurant.getOrderNum()) % 3 == 0 && myRestaurant.getOrderNum() != 0){
                minion.setIcon(minionimgs.remove(0));
            }
        }
        mainFrame.repaint();
    }
