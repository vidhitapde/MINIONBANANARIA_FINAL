    ...
    //checks for collision
    {
        ...
        if(switch2 == true && switch3 == false){
            if(focusLabel.getX() > 500 && focusLabel.getX()<850 && focusLabel.getY()>150 && focusLabel.getY()<900){
                ...
                foodKitchen.getFrame().repaint();
            }else if(focusLabel.getX() < 0|| focusLabel.getX() > 900 || focusLabel.getY() < 0 || focusLabel.getY() > 750){
                if(focusLabel == butter){
                    focusLabel.setBounds(100, 100, 200, 71);
                    focusLabel = null;
                }else if (focusLabel == sugar){
                    focusLabel.setBounds(100, 250, 200, 200);
                    focusLabel = null;
                }else if (focusLabel == banana){
                    focusLabel.setBounds(100, 500, 220, 188);
                    focusLabel = null;
                }
            }
            ...
            if(focusLabel.getX() > 250 && focusLabel.getX()<770 && focusLabel.getY()>250 && focusLabel.getY()<680){
                ...
                if(focusLabel == syrup){
                    focusLabel.setBounds(130, 20, 127, 210);
                    focusLabel = null;
                }else if (focusLabel == whippedCream){
                    focusLabel.setBounds(400, 20, 107, 219);
                    focusLabel = null;
                }else if (focusLabel == chocolateChips){
                    focusLabel.setBounds(700, 20, 233, 72);
                    focusLabel = null;
                }
            }
    ...
    // moves the pancake down onto the plate when space bar is pressed
    {
        ...
        timer = new Timer(10, new ActionListener(){
                ...
                public void actionPerformed(ActionEvent e){
                    ...
                    if(panel2.getPanY(pancake) < panel2.getRequiredY(pancake) || (!(panel2.getPanX(pancake) > 70 && panel2.getPanX(pancake) <505) && panel2.getRequiredY(pancake) < 330)){
